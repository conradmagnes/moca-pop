...
from moca_pop.aux_scripts.generate_template_file_mapping import (
    generate_template_json_mapping,
)
import moca_pop.utils.json_utils as json_utils

import moca_pop.model_templates.rigidBodyTemplate as rbt
